...
cm_tile_set(struct cm_tile * tile, uint16_t column, uint16_t row);
 ...
 */
CORE_API extern struct cm_tile
cm_tile_top_left_of(struct cm_tile const * center);
 ...
 */
CORE_API extern struct cm_tile
cm_tile_top_right_of(struct cm_tile const * center);
 ...
 */
CORE_API extern struct cm_tile
cm_tile_bottom_right_of(struct cm_tile const * center);
 ...
 */
CORE_API extern struct cm_tile
cm_tile_bottom_left_of(struct cm_tile const * center);
